...
public class DeleteHolidayInfo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeleteHolidayInfo frame = new DeleteHolidayInfo();
	...
	public DeleteHolidayInfo() {
		...
		JLabel lblEnterTheName = new JLabel("Enter the name whose holiday is to be deleted:");
